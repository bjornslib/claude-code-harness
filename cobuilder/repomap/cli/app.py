...
from cobuilder.repomap.cli.config import load_config
from cobuilder.repomap.cli.errors import error_handler
from cobuilder.repomap.cli.init_cmd import run_init
from cobuilder.repomap.cli.logging_setup import setup_logging
from cobuilder.repomap.cli.ontology import ontology_app
...
def _version_callback(value: bool) -> None:
    ...
    if value:
        from cobuilder.repomap import __version__
...
def init(
    ...
    with error_handler(_console):
        ...
        from cobuilder.repomap.cli.init_cmd import _is_git_repo
        ...
        if project_path is not None:
            from cobuilder.repomap.cli.init_cmd import run_baseline_generation
...
def generate(
    ...
    with error_handler(_console):
        ...
        from cobuilder.repomap.spec_parser.parser import ParserConfig
        ...
        if not skip_enrichment:
            ...
            try:
                ...
                from cobuilder.repomap.rpg_enrichment import InterfaceDesignEncoder
        ...
        if output:
            ...
            if baseline_graph is not None:
                from cobuilder.repomap.serena.delta_report import DeltaReportGenerator
