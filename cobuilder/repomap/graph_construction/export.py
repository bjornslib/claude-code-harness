...
class GraphExporter:
    ...
    def _export_attractor_from_func(self, graph: FunctionalityGraph) -> str:
        ...
        """
        from cobuilder.repomap.graph_construction.exporter import AttractorExporter  # noqa: PLC0415
        ...
        from cobuilder.repomap.models.enums import NodeLevel  # noqa: PLC0415
    ...
    def export_rpg_attractor(
        ...
        :class:`~zerorepo.graph_construction.exporter.AttractorExporter`.
        ...
        try:
            ...
            from cobuilder.repomap.models.enums import DeltaStatus  # noqa: PLC0415 (already imported at module level as side-effect)
