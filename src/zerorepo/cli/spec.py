...
def _load_spec(spec_path: Path) -> "RepositorySpec":  # noqa: F821
    ...
    """
    from zerorepo.spec_parser.models import RepositorySpec
...
def parse(
    ...
    with error_handler(_console):
        ...
        from zerorepo.spec_parser.parser import ParserConfig, SpecParser
...
def refine(
    ...
    with error_handler(_console):
        from zerorepo.llm.gateway import LLMGateway
        from zerorepo.spec_parser.refinement import RefinerConfig, SpecRefiner
...
def _print_spec_summary(spec: "RepositorySpec") -> None:  # noqa: F821
    ...
    from zerorepo.spec_parser.models import ConflictSeverity
