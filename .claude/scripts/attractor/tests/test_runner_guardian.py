...
from runner_guardian import PipelineHealth, RunnerGuardian  # noqa: E402
from runner_models import NodeAction, RunnerPlan, RunnerState  # noqa: E402
...
class TestRunnerGuardianVerifyChain(unittest.TestCase):
    ...
    def test_valid_chain_returns_true(self) -> None:
        from anti_gaming import ChainedAuditWriter
