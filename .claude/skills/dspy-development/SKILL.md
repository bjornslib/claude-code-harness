...
description: This skill should be used when the user asks to "build with DSPy", "create a DSPy module", "optimize prompts automatically", "build a RAG system", "create an AI agent", "use declarative LM programming", or mentions DSPy, dspy.Predict, dspy.ChainOfThought, MIPROv2, BootstrapFewShot, or Stanford NLP's framework for systematic LM programming.
version: 1.0.0
---
