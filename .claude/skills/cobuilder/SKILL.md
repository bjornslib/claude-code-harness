...
High-level workflows for the CoBuilder multi-agent pipeline, inspired by [superpowers](https://github.com/obra/superpowers). These sub-skills are used by CoBuilder, Guardian, and Orchestrators — not by workers directly.
...
### Full Initiative (CoBuilder / Guardian)
