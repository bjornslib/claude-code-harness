...
Reference [railpack.md](../railway-common/references/railpack.md) for build configuration.
Reference [monorepo.md](../railway-common/references/monorepo.md) for monorepo patterns.
...
See [monorepo.md](../railway-common/references/monorepo.md) for detailed patterns.
...
If no code exists, suggest minimal patterns from [railpack.md](../railway-common/references/railpack.md):
